<?php
/* template head */
/* end template head */ ob_start(); /* template body */ ?><!--__FUEL_MARKER__0--><?php $this->scope["project"]=fuel_model('projects', array('find'=>'one', 'where'=>array('featured'=>'yes'), 'order'=>'RAND()'))?>
