...
<div class="title write-link-d">Write</div>
        ...
        <div class="input-group half left-story">
            ...
            <div class="mini-form-class">
                <div class="input-group">
                    <input type="text" name="story_title" id="story_title" class="story_title" value="<?php echo set_value('story_title'); ?>" placeholder="Title">
                    <label for="story_title" class="hide-label">Title</label>
                </div>
                <div class="input-group">
                    <input type="text" name="description" id="description" class="description" value="<?php echo set_value('story_description'); ?>" placeholder="Description">
            ...
            <div class="mini-form-class">
                <div class="input-group half">
                    ...
                    <div class="input-group">
                        ...
                        echo "<select name=\"country\" id=\"country\" style=\"width: 228px\">";
                        ...
                        foreach ( $countries as $country ) {
                            ...
                            if ($this->input->post('country') == $country->country_id) {
                                echo $selected;
                            }
                ...
                <div class="input-group second half">
                    ...
                    <div class="input-group">
                        <input type="text" name="location" id="location" class="location" value="<?php echo set_value('location'); ?>" placeholder="City, town, region or area">
            ...
            <div class="mini-form-class">
                <div class="profile_left">
                    <div class="photo_holder">
                        <img src="<?php if ($this->input->post('story_photo') == 'default_story.png' || $this->input->post('story_photo') == '') {  echo base_url().'assets/users/default_story.png'; } else {  echo base_url().'assets/users/'.$user['folder'].'/story_temp/'.$this->input->post('story_photo');  } ?>" width="162" class="img">
                        <input type="hidden" value="<?php if ($this->input->post('story_photo') != '') { echo $this->input->post('story_photo'); } else { ?>default_story.png<?php } ?>" id="story_photo" name="story_photo">
                    </div>
                ...
                <div id="photo_hider">
                    <div id="photo_uploader">
                        <div class="profile_left">
                            <div class="photo_holder">
                                <img src="<?php echo base_url().'assets/users/default_story.png'; ?>" width="200" class="img">
                            </div>
...
<div class="clear"></div>
 ...
 <!--           <div class="input-group half country-drop">
                <div class="input-group">
                    <?php
/*
                    echo "<select name=\"category\" id=\"category\" style=\"width: 228px\">";
                    ...
                    foreach ( $categories as $category ) {
                        ...
                        if ($this->input->post('category') == $category->category_id) {
            ...
            <div class="input-group tags-box">
                <div class="input-group">
                    <input type="hidden" name="story_tags" id="story_tags" value="<?php echo set_value('story_tags'); ?>">
        ...
        <div class="mini-form-class">
            <div class="input-group">
                <textarea name="story" id="story" class="story" placeholder="Story"><?php echo set_value('story'); ?></textarea>
        ...
        <div class="input-group top20">
            <button name="submit-story" id="submit-story" class="sign-in finish-link">Submit Story!</button>
        </div>
    </form>
