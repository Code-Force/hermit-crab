                ...
                if (is_array($stories)) {
                    foreach ($stories as $story) {
                        if($limit_count <= $limit){
                            ...
                            $return .= '<div class="story '.$story['continent_name'].' '.$story['category_name'].$story['class_tags'].'">
                            <div class="info-top">
                                <div class="location">
                                    <img src="assets/images/msdropdown/icons/blank.gif" class="flag '.strtolower($story['iso']).' fnone" title="'.$story['nicename'].'" />
                                </div>
                                ...
                                <div class="share">
                                    ...
                                    <div class="share_this_but"></div>

                                    <!-- AddThis Button BEGIN -->
                                    <div addthis:url="'.base_url().$story['username'].'/'.$story['slug'].'" class="addthis_toolbox addthis_default_style addthis_16x16_style">
